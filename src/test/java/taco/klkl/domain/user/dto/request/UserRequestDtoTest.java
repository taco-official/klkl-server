...
class UserRequestDtoTest {
	...
	public void testValidUserCreateRequestDto() {
		// given
		UserCreateRequest requestDto = new UserCreateRequest("이름", "남", 20, "image/profileImageUrl.png", "자기소개");
	...
	public void testInvalidUserCreateRequestDto_NameRequired() {
		// given
		UserCreateRequest requestDto = new UserCreateRequest(null, "남", 20, "image/profileImageUrl.png", "자기소개");
	...
	public void testInvalidUserCreateRequestDto_AgeNegative() {
		// given
		UserCreateRequest requestDto = new UserCreateRequest("이름", "남", -1, "image/profileImageUrl.png", "자기소개");
